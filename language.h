...
class language{
    public:
        language();                       //@TODO rever isso, eu acho que ta meio tosco; tem que por o construtor pra padrão inglês
        void  initializeLanguage      (); //@TODO rever isso, eu acho que ta meio tosco :S
    ...
    private:
        // coloquei todos os setters em privado, tem que ver se da pra usar eles nos delegates.
